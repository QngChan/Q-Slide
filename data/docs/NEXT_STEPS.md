...
## Son Guncelleme
- 2026-03-18: Linux uyumluluğu saglandi (tkinter popup, xdg-open tarayici).
- 2026-03-18: Host sekmesi kapatildiginda uygulama otomatik kapaniyor.
- 2026-03-18: Host ekranina "İzleyiciyi Aç" ve "URL Kopyala" butonları eklendi.
- 2026-03-18: Host ve Viewer için tamamen siyah tonlarında yeni tema uygulandı.
- 2026-03-15: PDF formatı için doğrudan sunum yükleme desteği eklendi; API ve UI kısıtlamaları kaldırıldı.
...
- 2026-03-14: Host baslatma/calisma hatalarinda kullaniciya detayli popup yonlendirmeleri eklendi.
- 2026-03-14: Host web arayuzunde tum hata durumlari icin popup rehberi eklendi.
- 2026-03-14: Host ve Host UI icin hata doktoru akisi eklendi.
- 2026-03-14: Host UI yukleme alanlarina surukle-birak ile dosya yukleme eklendi.
- 2026-03-14: Host UI surukle-birak sirasinda desteklenmeyen dosyalar icin uyari bandi ve yukleme ilerleme gostergesi eklendi.
- 2026-03-14: Host UI uyari bandi otomatik kapanir hale getirildi; basarisiz dosyalar ayri hata panelinde listelenir.
